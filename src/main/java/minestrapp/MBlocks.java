...
public class MBlocks
{
	...
	public static void init()
	{
		...
		register(redwood_plank_stairs = new BlockStairBase(planks.getDefaultState().withProperty(BlockMPlanks.VARIANT, BlockMPlanks.EnumType.REDWOOD), planks.getTranslationKey() + "_" + BlockMPlanks.EnumType.REDWOOD.getUnlocalizedName()).setFlammable(20, 5));
		register(frozen_oak_plank_stairs = new BlockStairBase(planks.getDefaultState().withProperty(BlockMPlanks.VARIANT, BlockMPlanks.EnumType.FROZEN_OAK), planks.getTranslationKey() + "_" + BlockMPlanks.EnumType.FROZEN_OAK.getUnlocalizedName()).setFlammable(20, 5));
		register(charwood_plank_stairs = new BlockStairBase(planks.getDefaultState().withProperty(BlockMPlanks.VARIANT, BlockMPlanks.EnumType.CHARWOOD), planks.getTranslationKey() + "_" + BlockMPlanks.EnumType.CHARWOOD.getUnlocalizedName()));
		register(palm_plank_stairs = new BlockStairBase(planks.getDefaultState().withProperty(BlockMPlanks.VARIANT, BlockMPlanks.EnumType.PALM), planks.getTranslationKey() + "_" + BlockMPlanks.EnumType.PALM.getUnlocalizedName()).setFlammable(20, 5));
		...
		register(granite_brick_stairs = new BlockStairBase(decor_stone.getDefaultState().withProperty(BlockDecorativeStones.VARIANT, BlockDecorativeStones.DecorStoneType.GRANITE_BRICKS), decor_stone.getTranslationKey() + "_" + BlockDecorativeStones.DecorStoneType.GRANITE_BRICKS.getUnlocalizedName()));
		register(diorite_brick_stairs = new BlockStairBase(decor_stone.getDefaultState().withProperty(BlockDecorativeStones.VARIANT, BlockDecorativeStones.DecorStoneType.DIORITE_BRICKS), decor_stone.getTranslationKey() + "_" + BlockDecorativeStones.DecorStoneType.DIORITE_BRICKS.getUnlocalizedName()));
		register(andesite_brick_stairs = new BlockStairBase(decor_stone.getDefaultState().withProperty(BlockDecorativeStones.VARIANT, BlockDecorativeStones.DecorStoneType.ANDESITE_BRICKS), decor_stone.getTranslationKey() + "_" + BlockDecorativeStones.DecorStoneType.ANDESITE_BRICKS.getUnlocalizedName()));
		register(slate_brick_stairs = new BlockStairBase(decor_stone.getDefaultState().withProperty(BlockDecorativeStones.VARIANT, BlockDecorativeStones.DecorStoneType.SLATE_BRICKS), decor_stone.getTranslationKey() + "_" + BlockDecorativeStones.DecorStoneType.SLATE_BRICKS.getUnlocalizedName()));
		register(sandstone_brick_stairs = new BlockStairBase(sandstone.getDefaultState().withProperty(BlockMSandstone.VARIANT, BlockMSandstone.SandstoneType.SANDSTONE_BRICKS), sandstone.getTranslationKey() + "_" + BlockMSandstone.SandstoneType.SANDSTONE_BRICKS.getUnlocalizedName()));
		register(red_sandstone_brick_stairs = new BlockStairBase(sandstone.getDefaultState().withProperty(BlockMSandstone.VARIANT, BlockMSandstone.SandstoneType.RED_SANDSTONE_BRICKS), sandstone.getTranslationKey() + "_" + BlockMSandstone.SandstoneType.RED_SANDSTONE_BRICKS.getUnlocalizedName()));
		register(cold_sandstone_stairs = new BlockStairBase(sandstone.getDefaultState().withProperty(BlockMSandstone.VARIANT, BlockMSandstone.SandstoneType.COLD_SANDSTONE), sandstone.getTranslationKey() + "_" + BlockMSandstone.SandstoneType.COLD_SANDSTONE.getUnlocalizedName()));
		register(cold_red_sandstone_stairs = new BlockStairBase(sandstone.getDefaultState().withProperty(BlockMSandstone.VARIANT, BlockMSandstone.SandstoneType.COLD_RED_SANDSTONE), sandstone.getTranslationKey() + "_" + BlockMSandstone.SandstoneType.COLD_RED_SANDSTONE.getUnlocalizedName()));
		register(cold_sandstone_brick_stairs = new BlockStairBase(sandstone.getDefaultState().withProperty(BlockMSandstone.VARIANT, BlockMSandstone.SandstoneType.COLD_SANDSTONE_BRICKS), sandstone.getTranslationKey() + "_" + BlockMSandstone.SandstoneType.COLD_SANDSTONE_BRICKS.getUnlocalizedName()));
		register(cold_red_sandstone_brick_stairs = new BlockStairBase(sandstone.getDefaultState().withProperty(BlockMSandstone.VARIANT, BlockMSandstone.SandstoneType.COLD_RED_SANDSTONE_BRICKS), sandstone.getTranslationKey() + "_" + BlockMSandstone.SandstoneType.COLD_RED_SANDSTONE_BRICKS.getUnlocalizedName()));
		register(desert_quartz_stairs = new BlockStairBase(desert_quartz.getDefaultState().withProperty(BlockMQuartz.VARIANT, BlockMQuartz.EnumType.POLISHED), desert_quartz.getTranslationKey() + "_" + BlockMQuartz.EnumType.POLISHED.getName()));
		register(irradiant_quartz_stairs = new BlockStairBase(irradiant_quartz.getDefaultState().withProperty(BlockMQuartz.VARIANT, BlockMQuartz.EnumType.POLISHED), irradiant_quartz.getTranslationKey() + "_" + BlockMQuartz.EnumType.POLISHED.getName()));
		register(cobbled_red_rock_stairs = new BlockStairBase(cobblestone.getDefaultState().withProperty(BlockStoneBaseMOnly.VARIANT, EnumStoneTypeMOnly.RED_ROCK), cobblestone.getTranslationKey() + "_" + EnumStoneTypeMOnly.RED_ROCK.getUnlocalizedName()));
		register(cobbled_deep_red_rock_stairs = new BlockStairBase(cobblestone.getDefaultState().withProperty(BlockStoneBaseMOnly.VARIANT, EnumStoneTypeMOnly.DEEP_RED_ROCK), cobblestone.getTranslationKey() + "_" + EnumStoneTypeMOnly.DEEP_RED_ROCK.getUnlocalizedName()));
		register(cobbled_deepstone_stairs = new BlockStairBase(cobblestone.getDefaultState().withProperty(BlockStoneBaseMOnly.VARIANT, EnumStoneTypeMOnly.DEEPSTONE), cobblestone.getTranslationKey() + "_" + EnumStoneTypeMOnly.DEEPSTONE.getUnlocalizedName()));
		register(cobbled_coldstone_stairs = new BlockStairBase(cobblestone.getDefaultState().withProperty(BlockStoneBaseMOnly.VARIANT, EnumStoneTypeMOnly.COLDSTONE), cobblestone.getTranslationKey() + "_" + EnumStoneTypeMOnly.COLDSTONE.getUnlocalizedName()));
		register(cobbled_deep_coldstone_stairs = new BlockStairBase(cobblestone.getDefaultState().withProperty(BlockStoneBaseMOnly.VARIANT, EnumStoneTypeMOnly.DEEP_COLDSTONE), cobblestone.getTranslationKey() + "_" + EnumStoneTypeMOnly.DEEP_COLDSTONE.getUnlocalizedName()));
		register(cobbled_icestone_stairs = new BlockStairBase(cobblestone.getDefaultState().withProperty(BlockStoneBaseMOnly.VARIANT, EnumStoneTypeMOnly.ICESTONE), cobblestone.getTranslationKey() + "_" + EnumStoneTypeMOnly.ICESTONE.getUnlocalizedName()));
		register(cobbled_glacierrock_stairs = new BlockStairBase(cobblestone.getDefaultState().withProperty(BlockStoneBaseMOnly.VARIANT, EnumStoneTypeMOnly.GLACIERROCK), cobblestone.getTranslationKey() + "_" + EnumStoneTypeMOnly.GLACIERROCK.getUnlocalizedName()));
		register(cobbled_oceanstone_stairs = new BlockStairBase(cobblestone.getDefaultState().withProperty(BlockStoneBaseMOnly.VARIANT, EnumStoneTypeMOnly.OCEANSTONE), cobblestone.getTranslationKey() + "_" + EnumStoneTypeMOnly.OCEANSTONE.getUnlocalizedName()));
		register(cobbled_deep_oceanstone_stairs = new BlockStairBase(cobblestone.getDefaultState().withProperty(BlockStoneBaseMOnly.VARIANT, EnumStoneTypeMOnly.DEEP_OCEANSTONE), cobblestone.getTranslationKey() + "_" + EnumStoneTypeMOnly.DEEP_OCEANSTONE.getUnlocalizedName()));
		register(red_rock_brick_stairs = new BlockStairBase(stone_bricks.getDefaultState().withProperty(BlockStoneBaseMOnly.VARIANT, EnumStoneTypeMOnly.RED_ROCK), stone_bricks.getTranslationKey() + "_" + EnumStoneTypeMOnly.RED_ROCK.getUnlocalizedName()));
		register(deep_red_rock_brick_stairs = new BlockStairBase(stone_bricks.getDefaultState().withProperty(BlockStoneBaseMOnly.VARIANT, EnumStoneTypeMOnly.DEEP_RED_ROCK), stone_bricks.getTranslationKey() + "_" + EnumStoneTypeMOnly.DEEP_RED_ROCK.getUnlocalizedName()));
		register(deepstone_brick_stairs = new BlockStairBase(stone_bricks.getDefaultState().withProperty(BlockStoneBaseMOnly.VARIANT, EnumStoneTypeMOnly.DEEPSTONE), stone_bricks.getTranslationKey() + "_" + EnumStoneTypeMOnly.DEEPSTONE.getUnlocalizedName()));
		register(coldstone_brick_stairs = new BlockStairBase(stone_bricks.getDefaultState().withProperty(BlockStoneBaseMOnly.VARIANT, EnumStoneTypeMOnly.COLDSTONE), stone_bricks.getTranslationKey() + "_" + EnumStoneTypeMOnly.COLDSTONE.getUnlocalizedName()));
		register(deep_coldstone_brick_stairs = new BlockStairBase(stone_bricks.getDefaultState().withProperty(BlockStoneBaseMOnly.VARIANT, EnumStoneTypeMOnly.DEEP_COLDSTONE), stone_bricks.getTranslationKey() + "_" + EnumStoneTypeMOnly.DEEP_COLDSTONE.getUnlocalizedName()));
		register(icestone_brick_stairs = new BlockStairBase(stone_bricks.getDefaultState().withProperty(BlockStoneBaseMOnly.VARIANT, EnumStoneTypeMOnly.ICESTONE), stone_bricks.getTranslationKey() + "_" + EnumStoneTypeMOnly.ICESTONE.getUnlocalizedName()));
		register(glacierrock_brick_stairs = new BlockStairBase(stone_bricks.getDefaultState().withProperty(BlockStoneBaseMOnly.VARIANT, EnumStoneTypeMOnly.GLACIERROCK), stone_bricks.getTranslationKey() + "_" + EnumStoneTypeMOnly.GLACIERROCK.getUnlocalizedName()));
		register(oceanstone_brick_stairs = new BlockStairBase(stone_bricks.getDefaultState().withProperty(BlockStoneBaseMOnly.VARIANT, EnumStoneTypeMOnly.OCEANSTONE), stone_bricks.getTranslationKey() + "_" + EnumStoneTypeMOnly.OCEANSTONE.getUnlocalizedName()));
		register(deep_oceanstone_brick_stairs = new BlockStairBase(stone_bricks.getDefaultState().withProperty(BlockStoneBaseMOnly.VARIANT, EnumStoneTypeMOnly.DEEP_OCEANSTONE), stone_bricks.getTranslationKey() + "_" + EnumStoneTypeMOnly.DEEP_OCEANSTONE.getUnlocalizedName()));
		register(cobbled_shimmerstone_stairs = new BlockStairBase(shimmerstone.getDefaultState().withProperty(BlockShimmerstone.VARIANT, BlockShimmerstone.ShimmerstoneType.COBBLESTONE), shimmerstone.getTranslationKey() + "_" + BlockShimmerstone.ShimmerstoneType.COBBLESTONE.getUnlocalizedName()));
		register(shimmerstone_brick_stairs = new BlockStairBase(shimmerstone.getDefaultState().withProperty(BlockShimmerstone.VARIANT, BlockShimmerstone.ShimmerstoneType.BRICKS), shimmerstone.getTranslationKey() + "_" + BlockShimmerstone.ShimmerstoneType.BRICKS.getUnlocalizedName()));
		register(portar_stairs = new BlockStairBase(portar.getDefaultState().withProperty(BlockPortar.VARIANT, BlockPortar.PortarType.SLABBED), portar.getTranslationKey() + "_" + BlockPortar.PortarType.SLABBED.getUnlocalizedName()));
		register(gilded_brick_stairs = new BlockStairBase(gilded_stone.getDefaultState().withProperty(BlockGildedStone.VARIANT, BlockGildedStone.EnumType.BRICKS), gilded_stone.getTranslationKey() + "_" + BlockGildedStone.EnumType.BRICKS.getName()));
		...
		register(magnet_piston_1 = new BlockMagnetPistonBase(1).setRegistryName("magnet_piston1").setTranslationKey("magnet_piston").setCreativeTab(MTabs.utility));
		ForgeRegistries.BLOCKS.register(magnet_piston_2 = new BlockMagnetPistonBase(2).setRegistryName("magnet_piston2").setTranslationKey("magnet_piston"));
		ForgeRegistries.BLOCKS.register(magnet_piston_3 = new BlockMagnetPistonBase(3).setRegistryName("magnet_piston3").setTranslationKey("magnet_piston"));
		ForgeRegistries.BLOCKS.register(magnet_piston_4 = new BlockMagnetPistonBase(4).setRegistryName("magnet_piston4").setTranslationKey("magnet_piston"));
		...
		register(liquid_crystalfloe = new LiquidCrystalfloe(MFluids.crystalfloe, MMaterials.CRYSTALFLOE).setTranslationKey("crystalfloe").setRegistryName("crystalfloe"));
